; ClassManager.ClassTypes.ClassType.Builder = (function()
{
     ...
     * @returns {ClassManager.ClassTypes.ClassType.Builder}
     * @private
     */
    ClassTypeBuilder.prototype._setClass = function(className)
    {
        ...
        this._setClassDefinition(ClassManager.Tools.copy(this._class.getClassDefinition()));
    ...
    {
        if (!classDefinition || !ClassManager.Tools.isPlainObject(classDefinition)) {
    ...
    {
        if (!classProperties || !ClassManager.Tools.isPlainObject(classProperties)) {
    ...
    {
        if (!staticProperties || !ClassManager.Tools.isPlainObject(staticProperties)) {
    ...
    ClassTypeBuilder.prototype.addClassBody = function(classBody)
    {
        ...
        ClassManager.Tools.extend(classDefinition, classBody);
    ...
    ClassTypeBuilder.prototype.saveClass = function()
    {
        ...
        if (this._class) {
            this._class.setClassDefinition(this._getClassDefinition());
            return this._class;
        }
