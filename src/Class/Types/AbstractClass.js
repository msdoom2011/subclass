; ClassManager.ClassTypes.AbstractClass = (function() {
     ...
     * @constructor
     */
    var AbstractClass = ClassManager.ClassTypes.AbstractClass = function AbstractClass(classManager, className, classDefinition)
    {
     ...
     * @type {Class}
     */
    AbstractClass.$parent = ClassManager.ClassTypes.Class;
    ...
    {
        return ClassManager.ClassTypes.AbstractClass.Builder;
    };

    AbstractClass.prototype.setClassParent = function (parentClassName)
    {
        ClassManager.ClassTypes.ClassType.prototype.setClassParent.call(this, parentClassName);
    ...
    ClassManager.registerClassType(AbstractClass);
