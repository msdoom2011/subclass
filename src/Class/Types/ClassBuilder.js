; ClassManager.ClassTypes.Class.Builder = (function()
{
    ...
    ClassBuilder.$parent = ClassManager.ClassTypes.ClassType.Builder;
     ...
     * @returns {ClassManager.ClassTypes.Class.Builder}
     */
