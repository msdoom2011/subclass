; ClassManager.ClassTypes.Interface = (function()
{
    /*************************************************/
    ...
    Interface.$parent = ClassManager.ClassTypes.ClassType;
    ...
    {
        return ClassManager.ClassTypes.Interface.Builder;
    };
    ...
    Interface.prototype.getClassDefinitionProperties = function()
    {
        ...
        return ClassManager.Tools.extend(
            classProperties,
    ...
    {
        ClassManager.ClassTypes.ClassType.prototype.validateClassDefinition.call(this);
    ...
    ClassManager.registerClassType(Interface);
