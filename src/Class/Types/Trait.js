; ClassManager.ClassTypes.Trait = (function()
{
    /*************************************************/
    ...
    Trait.$parent = ClassManager.ClassTypes.ClassType;
    ...
    {
        return ClassManager.ClassTypes.Trait.Builder;
    };
    ...
    ClassManager.registerClassType(Trait);
