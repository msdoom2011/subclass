...
Subclass.Error.ErrorBase = function()
{
    ...
    // */
    //ErrorBase.create = function(type)
    //{
    //    if (!this.issetType(type)) {
    //        var message = type;
    //
    //        return (new ErrorBase(message)).apply();
    //    }
    ...
    // * @returns {Function}
    // */
    //ErrorBase.createConstructor = function(construct)
    //{
    ...
    // * @ignore
    // */
    //ErrorBase.attachOptionMethods = function()
    //{
    ...
    // */
    //ErrorBase.attachOptionProperties = function(errorInst)
    //{
    //    var options = this.getOptions();
    //
    //    for (var i = 0; i < options.length; i++) {
    ...
    // */
    //ErrorBase.registerType = function(typeName, typeConstructor)
    //{
    ...
    // *      The error type constructor function
    // */
    //ErrorBase.getType = function(typeName)
    //{
    //    if (!this.issetType(typeName)) {
    ...
    // * @returns {boolean}
    // */
    //ErrorBase.issetType = function(typeName)
    //{
    //    return !!this._types[typeName];
    //};
