; ClassManager.PropertyManager.PropertyTypes.CollectionType.Collection = (function()
{
    /**
    ...
    {
        if (!ClassManager.Tools.isPlainObject(items)) {
    ...
    {
        return ClassManager.Tools.extend({}, this._items);
    };
