; ClassManager.PropertyManager.PropertyTypes.ObjectCollection = (function()
{
    /*************************************************/
    ...
    ObjectCollectionType.$parent = ClassManager.PropertyManager.PropertyTypes.CollectionType;
    ...
    {
        return ClassManager.PropertyManager.PropertyTypes.ObjectCollection.Collection;
    };
    ...
    ObjectCollectionType.prototype.validate = function(value)
    {
        if (
            ...
            && (
                typeof value != 'object'
                || !ClassManager.Tools.isPlainObject(value)
            )
        ) {
    ...
    ObjectCollectionType.prototype.processPropertyDefinition = function()
    {
        ...
        if (
            ...
            && ClassManager.Tools.isPlainObject(defaultValue)
        ) {
    ...
    ClassManager.PropertyManager.registerPropertyType(ObjectCollectionType);
