; ClassManager.PropertyManager = (function()
{
    /**
    ...
    PropertyManager.prototype.createProperty = function(propertyName, propertyDefinition, contextClass, contextProperty)
    {
        ...
        if (!ClassManager.PropertyManager.issetPropertyType(propertyTypeName)) {
        ...
        if (!contextProperty && !ClassManager.isClassPropertyNameAllowed(propertyName)) {
        ...
        if (!(inst instanceof ClassManager.PropertyManager.PropertyTypes.PropertyType)) {
