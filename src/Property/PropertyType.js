; ClassManager.PropertyManager.PropertyTypes.PropertyType = (function()
{
    /**
    ...
    PropertyType.prototype.setContextClass = function(contextClass)
    {
        if ((
                ...
                contextClass
                && !(contextClass instanceof ClassManager.ClassTypes.ClassType)
            )
        ) {
    ...
    PropertyType.prototype.setContextProperty = function(contextProperty)
    {
        if ((
                ...
                contextProperty
                && !(contextProperty instanceof ClassManager.PropertyManager.PropertyTypes.PropertyType)
            )
        ) {
    ...
    PropertyType.prototype.getValue = function(context)
    {
        if (this.isUseAccessors()) {
            var getterName = ClassManager.Tools.generateGetterName(this.getPropertyName());
    ...
    PropertyType.prototype.setValue = function(context, value)
    {
        ...
        if (this.isUseAccessors()) {
            var setterName = ClassManager.Tools.generateSetterName(this.getPropertyName());
    ...
    PropertyType.prototype.attach = function(context)
    {
        ...
        if (ClassManager.Tools.isPlainObject(context)) {
    ...
    PropertyType.prototype.processPropertyDefinition = function()
    {
        ...
        this._propertyDefinition = ClassManager.Tools.extend(basePropertyDefinition, propertyDefinition);
    };
    ...
    ClassManager.Tools.extend(ClassManager.Tools, {
