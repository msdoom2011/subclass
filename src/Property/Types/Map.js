; ClassManager.PropertyManager.PropertyTypes.Map = (function()
{
    /*************************************************/
    ...
    MapType.$parent = ClassManager.PropertyManager.PropertyTypes.PropertyType;
    ...
    MapType.prototype.processPropertyDefinition = function()
    {
        ...
        if (
            ...
            && ClassManager.Tools.isPlainObject(schema)
    ...
    {
        if (defaultValue !== null && ClassManager.Tools.isPlainObject(defaultValue)) {
            for (var propName in defaultValue) {
                ...
                if (
                    ...
                    && ClassManager.Tools.isPlainObject(defaultValue[propName])
    ...
    ClassManager.PropertyManager.registerPropertyType(MapType);
