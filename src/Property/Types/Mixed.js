; ClassManager.PropertyManager.PropertyTypes.Mixed = (function()
{
    /*************************************************/
    ...
    MixedType.$parent = ClassManager.PropertyManager.PropertyTypes.PropertyType;
    ...
    MixedType.prototype.processPropertyDefinition = function()
    {
        ...
        if (allows && Array.isArray(allows)) {
            for (var i = 0; i < allows.length; i++) {
                if (!ClassManager.Tools.isPlainObject(allows[i])) {
                    continue;
                }
    ...
    ClassManager.PropertyManager.registerPropertyType(MixedType);
